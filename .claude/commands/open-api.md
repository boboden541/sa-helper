...
**Актуализируй `sa_documentation/tasks.md`**: если в аргументе есть id задачи (`[T<N>]`) — у задачи установи/обнови строку `> **Статус:** 🟡 Ожидает валидации` (замени существующую `> **Статус:**…` или добавь под заголовком задачи). Если `tasks.md` нет или id неизвестен — пропусти.
