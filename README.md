...
```bash
curl -sSL https://gitlab.com/boboden541/sa-helper/-/raw/main/install.sh -o /tmp/sa-install.sh && bash /tmp/sa-install.sh && rm /tmp/sa-install.sh
```
...
```
echo "alias init_sa='curl -sSL https://gitlab.com/boboden541/sa-helper/-/raw/main/install.sh -o /tmp/sa-install.sh && bash /tmp/sa-install.sh && rm /tmp/sa-install.sh'" >> ~/.zshrc
```
...
echo "alias init_sa='curl -sSL https://gitlab.com/boboden541/sa-helper/-/raw/main/install.sh -o /tmp/sa-install.sh && bash /tmp/sa-install.sh && rm /tmp/sa-install.sh'" >> ~/.bashrc
```
